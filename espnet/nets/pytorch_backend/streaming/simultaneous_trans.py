...
class SimultaneousSTE2E(object):
    ...
    def read_action_ulstm(self, x, segments=None, segment_step=0):
        ...
        logging.info('prev_states: ' + str(len(self.previous_encoder_recurrent_state)) + ', ' + str(self.previous_encoder_recurrent_state[0]), str(self.previous_encoder_recurrent_state))
        if self.enc_states is None:
